...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { alcoholpercentage: @beer.alcoholpercentage, description: @beer.description, kind: @beer.kind, name: @beer.name }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { alcoholpercentage: @beer.alcoholpercentage, description: @beer.description, kind: @beer.kind, name: @beer.name }
    assert_redirected_to beer_path(assigns(:beer))
  end
